...
void Proceso(float &seno, float &coseno, float &tangente, float &secante, float &cosecante, float &cotangente, float &num)
{
	float x, term;
	int dem;
...
int main()
{
	float num, seno = 0, coseno = 0, tangente = 0, secante = 0, cosecante = 0, cotangente = 0;
    int op;
	
	Proceso(seno, coseno, tangente, secante, cosecante, cotangente, num);
